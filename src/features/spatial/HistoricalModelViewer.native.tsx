...
const styles = StyleSheet.create({
  ...
  choice: { flex: 1, minHeight: 43, borderRadius: 11, borderWidth: 1, borderColor: '#3b4047' },
  ...
  trust: { flex: 1, minHeight: 36, borderRadius: 11, borderWidth: 1, borderColor: '#3b4047' },
  ...
  secondary: { flex: 1, minHeight: 43, borderRadius: 13, borderWidth: 1, borderColor: '#494e55' },
  secondaryText: { color: '#c8b995', fontSize: 9.5, fontWeight: '900' },
  primary: { flex: 1.35, minHeight: 43, borderRadius: 13, backgroundColor: '#d7bb84' },
