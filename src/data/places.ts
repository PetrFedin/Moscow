...
export const places: Place[] = [
  ...
  },
  {
    ...
    latitude: 55.7541,
    longitude: 37.6325,
    shortStory: 'Финал прогулки показывает исчезнувшую городскую границу: каменная стена Китай-города XVI века почти ушла с поверхности, но основание Варваринской башни сохранилось и входит в охраняемый памятник.',
    tags: ['утрачено', 'городская стена', 'фортификация'],
    experienceMinutes: 7,
    arReady: false,
    vrReady: false,
    highlights: [
      'представить восточную границу Китай-города в масштабе современной площади',
      'понять, почему большая часть стены исчезла в 1930-е годы',
      'узнать, что основание Варваринской башни 1534–1538 годов сохранилось в переходе станции метро «Китай-город»'
    ],
    sources: [
      { label: 'Мосгорнаследие — стена Китай-города и нижняя часть Варваринской башни, ГИКЭ 2022', url: 'https://www.mos.ru/upload/documents/files/743/GIKEStenaKitai-goroda_MoskvaKitaigorodskiiprd2(chast)d2(chast).pdf' },
      { label: 'Мосгорнаследие — предмет охраны стены Китай-города и основания Варваринской башни', url: 'https://www.mos.ru/upload/documents/files/3108/AktKitaigorodskayastenaNovayaNovaya.pdf' }
    ],
    periods: [
      {
        id: 'varvarka-gates-1538',
        label: 'Каменная граница Китай-города',
        year: '1534–1538',
        summary: 'В 1535 году началось строительство каменных укреплений Китай-города под руководством Петра Малого; основание Варваринской башни датируется 1534–1538 годами и сегодня входит в предмет охраны памятника.',
        confidence: 'documented'
      },
      {
        id: 'varvarka-gates-1934',
        label: 'Разборка укреплений',
        year: '1933–1934',
        summary: 'Весной 1933 года снос Варваринской башни планировали, но отложили из-за выселения жильцов. Осенью 1934 года была снесена большая часть Китайгородских стен.',
        confidence: 'documented'
      },
      {
        id: 'varvarka-gates-today',
        label: 'Основание башни под землёй',
        year: 'Сегодня',
        summary: 'Нижняя часть Варваринской башни 1534–1538 годов сохраняется как часть федерального объекта культурного наследия; основание находится в переходе станции метро «Китай-город».',
        confidence: 'documented'
      }
    ]
  }
